...
/* Adicionar nova linha da tabela de itens*/
...
$(".crud-submit").click(function(e) {
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Item Criado com sucesso.', 'Success Alert', { timeOut: 5000 });
    });
});
...
$("body").on("click", ".remove-item", function() {
    ...
    $.ajax({
        ...
        c_obj.remove();
        toastr.success('Item deletado com sucesso.', 'Success Alert', { timeOut: 5000 });
    });
});
